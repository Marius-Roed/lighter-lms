...
$settings = lighter_lms_get_course_settings($post);
?>
...
<div class="grid">
	...
	<div class="course-slug">
		...
		<div class="content grid">
			<span class="col-full"><?php echo esc_html(
       site_url($course_post->rewrite["slug"]),
   ); ?>/<b class="editable-text"><?php echo esc_html($post->post_name); ?></b>
			</span>
		</div>
	</div>
	<div class="lessons">
