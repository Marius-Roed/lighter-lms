...
<main id="main" <?php echo esc_attr( post_class( 'site-main' ) ); ?> data-course-id="<?php echo esc_attr( $post->ID ); ?>">
	<?php lighter_course_sidebar( $post ); ?>
	<div class="content-wrap">
		...
		<?php
		$btn_class = $lesson_id ? array( 'complete-lesson' ) : array( 'complete-lesson', 'lighter-hidden' );
		?>
